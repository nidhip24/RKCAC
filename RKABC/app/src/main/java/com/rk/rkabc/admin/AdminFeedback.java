 ...
 * {@link AdminFeedback.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link AdminFeedback#newInstance} factory method to
...
public class AdminFeedback extends Fragment {
    ...
    public static AdminFeedback newInstance(String param1, String param2) {
        AdminFeedback fragment = new AdminFeedback();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button b = view.findViewById(R.id.mdown);
    ...
    void makerequest(){
        URL u = new URL();
        StringRequest s = new StringRequest(Request.Method.POST, u.url+"excelfeed.php", new Response.Listener<String>() {
            @Override
