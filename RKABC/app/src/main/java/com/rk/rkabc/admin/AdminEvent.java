 ...
 * {@link AdminEvent.OnFragmentInteractionListener} interface
...
public class AdminEvent extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        del.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getActivity(),DeleteEvent.class);
                startActivity(i);
            }
        });
    ...
    void makerequest(){
        URL u = new URL();
        StringRequest s = new StringRequest(Request.Method.POST, u.url+"exceleve.php", new Response.Listener<String>() {
            @Override
